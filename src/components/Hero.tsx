    ...
    <section className="body-font bg-gray-900 text-gray-500">
      <main>
        <div className="container mx-auto flex flex-col items-center px-5 py-12 md:flex-row">
          ...
          <div className="flex flex-col  md:items-start md:pl-16 md:text-left lg:flex-grow lg:pl-24">
            ...
            <div className="flex">
              ...
              <a
                ...
                href="https://drive.google.com/file/d/1WL5bIjipkpulVW6a3gcwHgMGpvvU6IFq/view?usp=sharing"
                data-mode="popup"
                className="umami--click--hero-contact ml-4 inline-flex cursor-pointer rounded border-0 bg-gray-800 py-2 px-6 text-lg text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none"
                data-size="100">
                Resume
              </a>
            </div>
