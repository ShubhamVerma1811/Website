		...
		<>
			...
			<div className="mx-auto flex h-[500px] flex-col rounded-md border border-gray-700 p-2 md:w-[350px]">
				...
				>
					<p
						ref={textRef}
						className="select-none break-all text-[10px] text-transparent transition-all duration-500 ease-in-out"
					>
						{text}
					</p>
					...
					<div className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform">
						<div className="m-auto flex h-36 w-36 items-center justify-center rounded-full bg-skin-primary opacity-90">
							<p className="select-none font-secondary font-semibold text-3xl text-skin-secondary italic">
								Ness
							</p>
						</div>
					</div>
				...
				<div className="mt-auto p-2">
					...
					<p className="my-2 w-max rounded-full border border-gray-500 p-2 text-md text-skin-secondary">
						PCI Compliance
					</p>
				</div>
			</div>
